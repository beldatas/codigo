 ...
 * do some work.
 */
public class BalancoAlarmReceiver extends WakefulBroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		 ...
		 */
		Intent service = new Intent(context, BalancoSchedulingService.class);
	...
	public void setAlarm(Context context) {
		...
		Intent intent = new Intent(context, BalancoAlarmReceiver.class);
