...
public class RRDLister extends BasePrintActivity implements OnClickListener {
    ...
    protected void onPrintData(Object mainData, Object autodeData) {
        BasePrintBitmap rrdPrintBitmap = new RRDPrintBitmap(this,
                (RRDData) mainData, (DadosDoAuto) autodeData);
    ...
    private void addNoResultView() {
        RelativeLayout rrd_lister_layout = (RelativeLayout) findViewById(R.id.rrd_lister_layout);
        cursor.close();
    ...
    private void addResultView() {
        RRDListerExpandableAdapter expandableAdapter = new RRDListerExpandableAdapter(cursor,
                RRDLister.this);
        ExpandableListView expandableListView = (ExpandableListView) findViewById(R.id.expandableListViewRrd);
