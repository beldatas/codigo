...
public class TAVDatabaseHelper extends SQLiteOpenHelper {
	...
	public static final String DATABASE_NAME_TCA = "database_tav.db";
	...
	public static final String NUMERO_DO_CHASSI = "numero_do_chassi";
	...
	public static final String TABLE_SQL = "CREATE TABLE " + TABLE_NAME + " ("
			...
			+ " TEXT, " + NUMERO_DO_AUTO + " TEXT, " + NOME_DO_PROPRIETARIO
			+ " TEXT, " + CPF_CNPJ + " TEXT, " + NUMERO_DO_RENAVAM + " TEXT, "
			+ NUMERO_DO_CHASSI + " TEXT, " + CABECA_DE_ALAVANCA + " TEXT, "
			...
			+ " TEXT, " + NUMERO_TAV + " TEXT UNIQUE )";

	public TAVDatabaseHelper(Context context) {
		super(context, DATABASE_NAME_TCA, null, DatabaseCreator.VERSION);
	}
