...
public class PlacaSearchDatabaseHelper extends SQLiteOpenHelper {
	...
	public static final String COLUMN_COR = "cor_veiculo";
	...
	private final String TABLE_SQL = "CREATE TABLE [veiculos] (_id integer NOT NULL PRIMARY KEY AUTOINCREMENT UNIQUE,placa text,modelo text,cor_veiculo text,tipo text,ano_licenciamento text,data_licenciamento text,status_licenciamento text,ipva text,seguro text,status text,infracoes text,restricoes text,date text,latitude text,longitude text)";
