...
public class SetttingDatabaseHelper extends SQLiteOpenHelper {
	...
	public final String SETTING_TABLE_SQL = "CREATE TABLE [setting] (_id integer NOT NULL PRIMARY KEY AUTOINCREMENT UNIQUE,auto_bacckup text DEFAULT false,language text,vibrator text DEFAULT true,ringtone text DEFAULT true,font text DEFAULT 1)";
